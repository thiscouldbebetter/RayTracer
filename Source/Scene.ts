...
class Scene implements Serializable<Scene>
{
	...
	static demo_MaterialEyeball(): Material
	{
		/*
		...
		*/
		...
		var imageEyeball = ImageFromDataUrl.fromNameAndDataUrl
		(
			"ImageEyeball",
	...
	static demo_MaterialRTBang(): Material
	{
	...
	static demo_SphereEyeball(materialEyeball: Material): Sphere
	{
